 ...
 * @since JDK 1.8
 */
public class WeixinOAuthTemplate extends OAuth2Template {
    ...
    public WeixinOAuthTemplate(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
