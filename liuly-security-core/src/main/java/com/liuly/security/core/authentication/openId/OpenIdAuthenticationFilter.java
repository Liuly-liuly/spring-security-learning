...
public class OpenIdAuthenticationFilter extends
    ...
    public static final String SPRING_SECURITY_FORM_PROVIDER_KEY = "providerId";

    private String openIdParameter = SPRING_SECURITY_FORM_OPEN_KEY;
    private String providerIdParameter = SPRING_SECURITY_FORM_PROVIDER_KEY;
